...
public class TrayMarkerDecorator extends EditPartMarkerDecorator {
	...
	public TrayMarkerDecorator(EObject modelObject) {
		super(modelObject);
	}

	public TrayMarkerDecorator(List modelObjects) {
		super(modelObjects);
	}

	public TrayMarkerDecorator(EObject modelObject, AbstractLayout layout) {
		super(modelObject, layout);
	}
	
	public TrayMarkerDecorator(List modelObjects, AbstractLayout layout) {
		super(modelObjects, layout);
	}
