 ...
 */
public abstract class AbstractTC extends TestCase  {
    ...
    protected void runTest(int compare, String source, String expected) throws IOException, RecognitionException {
    ...
    protected XPath10Parser createParser(String testString) throws IOException {
    ...
    private XPath10Lexer createLexer(String testString) throws IOException {
