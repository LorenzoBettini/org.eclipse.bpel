 ...
 * <p>
 * Note (VZ): this class was copied here to keep backward-compatibility with Helios.
 * It can be removed the day the BPEL Designer starts using Eclipse "Indigo" 3.7 (and higher versions).
 * </p>
 *
 * @since 2.7
 */
