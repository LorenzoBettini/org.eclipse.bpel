...
public class BasicEObjectaAdapter extends AbstractStatefulAdapter 
	...
	implements IProperty<String, Object> ,
			   INamespaceMap<String, String> {

	
	/** For generic properties associated with an EObject; this are transient and not saved */
	 ...
	 * @see org.eclipse.bpel.model.adapters.IProperty#setProperty(java.lang.Object, java.lang.Object)
	 */
	...
	public boolean containsKey(Object key) {
		return fPrefix2Namespace != null ? fPrefix2Namespace.containsKey(key) : false;		
	}
	...
	public boolean containsValue(Object value) {
		return fPrefix2Namespace != null ?  fPrefix2Namespace.containsValue(value) : false;
	}
