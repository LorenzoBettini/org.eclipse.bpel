...
public class BPELPackageImpl extends EPackageImpl implements BPELPackage {
	...
	public void createPackageContents() {
		...
		createEReference(invokeEClass, INVOKE__TO_PART);
		createEReference(invokeEClass, INVOKE__FROM_PART);
		...
		createEReference(replyEClass, REPLY__TO_PART);
		...
		createEReference(onMessageEClass, ON_MESSAGE__FROM_PART);
		...
		createEReference(fromPartEClass, FROM_PART__TO);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProcess_QueryLanguage(), ecorePackage.getEString(), "queryLanguage", "http://www.w3.org/TR/1999/REC-xpath-19991116", 0, 1, org.eclipse.bpel.model.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
